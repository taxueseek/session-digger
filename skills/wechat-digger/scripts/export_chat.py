...
# Share the table-naming contract with scripts/wechat_schema.py. Bootstrap the
# parent directory because this script also runs standalone as a subprocess.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
from wechat_schema import message_table  # noqa: E402
...
def message_table_for(chat_id: str) -> str:
    """Shard table for a chat id — kept as a thin alias for shared schema."""
    return message_table(chat_id)
